...
const db = {
  ...
  async init() {
    ...
    // New add (Aug 1 2026): Espeon VMAX
    addIfMissing('pokemon',
      'Espeon VMAX 2021 Sword & Shield Fusion Strike #270 Full Art Secret Rare PSA 10',
    ...
    // New add (Aug 24 2026): Snorlax VMAX SWSH #142 Full Art PSA 10
    addIfMissing('pokemon',
      'Snorlax VMAX 2020 Pokemon Sword & Shield #142/202 Full Art PSA 10',
    ...
    // REMOVED (Sep 15 2026): per Denny - off the site + eBay
    for (const removedSlug of [
      'zygarde-gx-sv65-hidden-fates-psa10',
      'edward-newgate-op13-042-alt-art-psa10',
      'divine-departure-op13-076-alt-art-psa10'
