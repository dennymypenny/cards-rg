...
function seedSampleData() {
  ...
  prepare(ins).run(catNBA,
    ...
    'Michael Jordan 1997-98 Fleer Showcase Row 0 #15. Fleer Showcase Row 0 is the short-printed top tier of the iconic Showcase set — notoriously hard to find. A true grail piece for any MJ or 90s NBA collection. 6x NBA Champion, Hall of Famer, Chicago Bulls. Ships double-sleeved in a rigid top-loader, securely bubble-wrapped.',
  ...
  prepare(ins).run(catNBA,
    ...
    'Stephen Curry 2009-10 Topps Gold Refractor Rookie Card, serial numbered /2009. A numbered Steph Curry rookie — the man who changed basketball forever. The Gold Refractor parallel is one of the most collectible from his debut year. Ships double-sleeved in a rigid top-loader, securely packed.',
  ...
  prepare(ins).run(catNBA,
    ...
    'Kobe Bryant 2000 Leaf Pearl Pearlescent Patch #24, serial 3/3. ONE OF ONLY THREE IN EXISTENCE. This is one of only three copies of this card ever made. A once-in-a-collection opportunity. Ultra-premium, ultra-rare. Ships fully insured, signature required.',
    150000, null, 1, 'CRG-KB-00-PATCH-3', null, 'Grail');

  // ── SOCCER ───────────────────────────────────────────────────────────────────
  prepare(ins).run(catSoccer,
    'Messi / Pele / Beckham / Maradona 2021 Leaf Fabled Four Quad Auto /25',
    'messi-pele-beckham-maradona-2021-leaf-fabled-four-quad-auto',
    'Messi / Pele / Beckham / Maradona — 2021 Leaf Fabled Four #TFF-01, serial /25. Four of the greatest footballers in history on a single quad-autograph card, serial numbered to just 25. A piece of soccer history. Ships double-sleeved in a rigid top-loader, securely bubble-wrapped.',
    60000, null, 1, 'CRG-QUAD-AUTO-25', null, 'Grail');

  prepare(ins).run(catSoccer,
    'Lionel Messi 2022 Donruss Pitch Kings Green Parallel SGC 10',
    'lionel-messi-2022-donruss-pitch-kings-green-parallel-sgc-10',
    'Lionel Messi 2022 Donruss Pitch Kings Green Parallel, graded SGC 10 Gem Mint — the highest possible grade. Clean corners, perfect centering, flawless surface. Comes in the original SGC slab. Ships in original SGC slab, bubble-wrapped and boxed securely.',
  ...
  console.log('CRG Cards products seeded (v' + SEED_VERSION + ')');
}
